...
import com.todocode.consultorioodontologico.logica.Secretario;
...
public class SecretarioJpaController implements Serializable {
    ...
    public void create(Secretario obj) {
    ...
    public void edit(Secretario obj) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            Secretario obj;
            try {
                obj = em.getReference(Secretario.class, id);
                obj.getId();
